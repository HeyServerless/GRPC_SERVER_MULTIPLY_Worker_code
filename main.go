...
import (
	...
	pb "github.com/rajeshreddyt/GrpcServerMultiply/MULTIPLY"
)
...
func (s *server) MultiplyMethod(ctx context.Context, req *pb.MultiplyRequest) (*pb.MultiplyResponse, error) {
	...
	// 	Operation: pb.ComputationRequest_MULTIPLY,
	// }
